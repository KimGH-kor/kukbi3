...
public class Account2 {
	...
	Account2(String name, String no, String pw, int bal){
		this.name = name;
		this.no = no;
		this.pw = pw;
		this.bal = bal;
	}
	Account2(String name, String no, String pw){//잔고가 주어지지 않았을때
		this(name, no, pw, 0);
	}
	...
	//sendAcc amnt만큼 송금
	boolean send(Account2 sendAcc, int amnt, String pw) {//송금하기
